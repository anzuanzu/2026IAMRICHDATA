...
function updateMonthlyDisplay() {
    ...
    document.getElementById('march-total').textContent = `${monthlyStats['2026-03'].total.toLocaleString()}萬`;
    document.getElementById('march-finance').textContent = `${monthlyStats['2026-03'].finance.toLocaleString()}萬`;
    document.getElementById('march-insurance').textContent = `${monthlyStats['2026-03'].insurance.toLocaleString()}萬`;

    document.getElementById('april-total').textContent = `${monthlyStats['2026-04'].total.toLocaleString()}萬`;
    document.getElementById('april-finance').textContent = `${monthlyStats['2026-04'].finance.toLocaleString()}萬`;
    document.getElementById('april-insurance').textContent = `${monthlyStats['2026-04'].insurance.toLocaleString()}萬`;

    document.getElementById('may-total').textContent = `${monthlyStats['2026-05'].total.toLocaleString()}萬`;
    document.getElementById('may-finance').textContent = `${monthlyStats['2026-05'].finance.toLocaleString()}萬`;
    document.getElementById('may-insurance').textContent = `${monthlyStats['2026-05'].insurance.toLocaleString()}萬`;

    document.getElementById('june-total').textContent = `${monthlyStats['2026-06'].total.toLocaleString()}萬`;
    document.getElementById('june-finance').textContent = `${monthlyStats['2026-06'].finance.toLocaleString()}萬`;
    document.getElementById('june-insurance').textContent = `${monthlyStats['2026-06'].insurance.toLocaleString()}萬`;

    document.getElementById('july-total').textContent = `${monthlyStats['2026-07'].total.toLocaleString()}萬`;
    document.getElementById('july-finance').textContent = `${monthlyStats['2026-07'].finance.toLocaleString()}萬`;
    document.getElementById('july-insurance').textContent = `${monthlyStats['2026-07'].insurance.toLocaleString()}萬`;

    document.getElementById('august-total').textContent = `${monthlyStats['2026-08'].total.toLocaleString()}萬`;
    document.getElementById('august-finance').textContent = `${monthlyStats['2026-08'].finance.toLocaleString()}萬`;
    document.getElementById('august-insurance').textContent = `${monthlyStats['2026-08'].insurance.toLocaleString()}萬`;

    document.getElementById('september-total').textContent = `${monthlyStats['2026-09'].total.toLocaleString()}萬`;
    document.getElementById('september-finance').textContent = `${monthlyStats['2026-09'].finance.toLocaleString()}萬`;
    document.getElementById('september-insurance').textContent = `${monthlyStats['2026-09'].insurance.toLocaleString()}萬`;

    document.getElementById('october-total').textContent = `${monthlyStats['2026-10'].total.toLocaleString()}萬`;
    document.getElementById('october-finance').textContent = `${monthlyStats['2026-10'].finance.toLocaleString()}萬`;
    document.getElementById('october-insurance').textContent = `${monthlyStats['2026-10'].insurance.toLocaleString()}萬`;

    document.getElementById('november-total').textContent = `${monthlyStats['2026-11'].total.toLocaleString()}萬`;
    document.getElementById('november-finance').textContent = `${monthlyStats['2026-11'].finance.toLocaleString()}萬`;
    document.getElementById('november-insurance').textContent = `${monthlyStats['2026-11'].insurance.toLocaleString()}萬`;
}
